...
export default {
    ...
    methods: {
        ...
        select: function() {
            ...
            console.log("fadeWidth: ", this.fadeWidth);
            console.log("fadeHeight: ", this.fadeHeight);
            ...
            if(this.ifSelect == 1) {
                ...
                setTimeout(function(){ 
                    ...
                    // Label 길이 늘림
                    setTimeout(function(){ document.getElementsByClassName("LabelContainer")[0].style.visibility = "visible"; }, 150);
                    // LabelContainer
                    clearTimeout();
                    }, 10);
                    clearTimeout();
